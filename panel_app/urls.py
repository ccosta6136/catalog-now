...
from panel_app.views import CatalogCreate, CatalogList, CatalogUpdate, PanelLogin, PanelLogout, ProductCreate, ProductDelete, ProductList, ProductUpdate, SignUpView, UserProfile, UserUpdate, AdminProducts
